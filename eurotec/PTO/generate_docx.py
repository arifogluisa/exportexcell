...
def extract_data_from_excell(file_name: str, sheet_name: str) -> None:
    ...
    for main_row_index in range(3, len(df), 9):
        ...
        oem_claims = tuple(main_row.items())[8][1]

        performance_claims = get_performance_claims(api, oem_claims)
        row_item = {
            "pds_no": pds_no,
...
excell_files = extract_data_from_excell("../exc_temp.xlsx", "PTO")
