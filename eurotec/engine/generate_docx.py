...
def extract_data_from_excell(file_name: str, sheet_name: str) -> None:
    ...
    for main_row_index in range(3, len(df), 9):
        ...
        performance_claims = get_performance_claims(api, ilsac, acea, oem_claims)
...
excell_files = extract_data_from_excell('../exc_temp.xlsx', 'Engine Oil')
